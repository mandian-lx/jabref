...
# Use system jars
export CLASSPATH=$(build-classpath antlr antlr3 antlr3-runtime antlr4 antlr4-runtime commons-cli commons-logging fontbox glazedlists guava jempbox jgoodies-common jgoodies-forms jgoodies-looks jna microba mysql-connector-java pdfbox postgresql-jdbc spin stringtemplate stringtemplate4/ST4 swingx)
#   plugins
...
%install
# Shell script
%jpackage_script net.sf.jabref.JabRefMain "" "" antlr:antlr3:antlr3-runtime:antlr4-runtime:commons-cli:commons-logging:glazedlists:guava:jempbox:jgoodies-common:jgoodies-forms:jgoodies-looks:jpf:jpf-boot:jpfcodegen-rt:microba:mysql-connector-java:pdfbox:postgresql-jdbc:spin:stringtemplate4/ST4:swingx:jabref jabref true
